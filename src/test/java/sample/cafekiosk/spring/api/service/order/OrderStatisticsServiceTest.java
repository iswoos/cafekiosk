...
class OrderStatisticsServiceTest {
    ...
    void sendOrderStatisticsMail() {
        LocalDateTime now = LocalDateTime.of(2024, 3, 5, 00, 0);
        ...
        Order order4 = createPaymentCompletedOrder(LocalDateTime.of(2024, 3, 6, 00, 0), products);

        // 실제 구현되어 있는 sendEmail에 따라 예외가 발생하는 게 아닌, true를 리턴하게끔 Mock에 대해 원하는 가짜 행위를 지정함
